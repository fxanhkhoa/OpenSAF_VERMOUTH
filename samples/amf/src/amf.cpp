...
#define MD5_LEN 32
//extern "C" to call C function inside C++ code
...
{ 
	//to debug in syslog
	syslog(LOG_DEBUG,"I'm Alive!"); 
	system("sudo ifconfig eth0:server 10.0.3.105");
	return 0; 
}
...
{ 
	//to debug in syslog
	syslog(LOG_DEBUG,"I'm Dedededed!"); 
	system("sudo ifconfig eth0:server down");
	return 0; 
}
...
int main(int argc, char **argv)
{
	...
	*/
	...
	while (1) {
		...
		//syslog(LOG_DEBUG,"Hello ajinomoto");
	}
